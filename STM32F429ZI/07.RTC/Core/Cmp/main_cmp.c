...
//uint8_t bt_rx_data;  // uart6 bt rx data - bt = bluetooth
//volatile int TIM10_10ms_counter = 0;     //
//volatile int TIM10_10ms_ultrasonic = 0;  // time of ultrasonic
//volatile int TIM10_10ms_led_blink_counter = 0; // time of dcmotor
///* USER CODE END PV */
//
...
//extern void bt_command_processing(void);  // ?���????????? ?��?��?�� ?��?��. ?��?�� 먹어?��.
...
//{
//	if (htim-> Instance == TIM10)  // time 10 divide
//	{
//		TIM10_10ms_counter++;  // 10ms timer counter
//		TIM10_10ms_ultrasonic++; // ultrasonic trigger timer
//		TIM10_10ms_led_blink_counter++; // for dcmotor.c led forward backward direction check
//	}
//}
//
//void delay_us(unsigned long us)
...
// HAL_TIM_Base_Start_IT(&htim10); // ADD_JINWAN_1011
// HAL_TIM_Base_Start_IT(&htim11); // ADD_JINWAN_1011
...
// //	 DHT11_main();
//
// // i2c_lcd_main();       // ?��?��?���???? ?��차적?���???? 진행?��?��?�� i2c_lcd_main(); ?��?�� ?��?�� 무한 루프�???? ?��?��간다. �???? ?��??.
// // servo_motor_test_main();  // test ?���?? 막기.
//
//  /* USER CODE END 2 */
//
//  /* Infinite loop */
...
//	  ultrasonic_processing(); // 거리
//	  dcmotor_pwm_control();
//	  get_rtc();  // YY MM DD HH MIN SS
//	  lcd_display_mode_select();
//	  set_time_button_ui();
//
//	  //	  printf("1337\n");
//	  //	  HAL_Delay(100);
//	  //	  toggle();    //  DHT11_processing();  ultrasonic_processing();
//
//
//	  //	  if (TIM10_10ms_counter == 5)  //50ms
//	  //	  {
//	  //		  HAL_GPIO_TogglePin(GPIOB, GPIO_PIN_0);      		// LED 1    // 50ms마다 toggle
//	  //	  }
//	  //	  if (TIM10_10ms_counter == 10)  //100ms
//	  //	  {
//	  //		  HAL_GPIO_TogglePin(GPIOB, GPIO_PIN_7);  			// LED 2    // 100ms마다 toggle
//	  //	  }
//	  //	  if (TIM10_10ms_counter == 15)  //150ms
//	  //	 {
//	  //         HAL_GPIO_TogglePin(GPIOB, GPIO_PIN_14);            // LED 3   // 150ms마다 toggle
//	  //         TIM10_10ms_counter = 0;
//	  //	 }
//
//    /* USER CODE END WHILE */
...
//
//  /*Configure GPIO pin Output Level */
//  HAL_GPIO_WritePin(GPIOE, IN1_DCMOTOR_Pin|IN2_DCMOTOR_Pin|NEW_LED_Pin, GPIO_PIN_RESET);
//
//  /*Configure GPIO pin Output Level */
...
//
//  /*Configure GPIO pins : IN1_DCMOTOR_Pin IN2_DCMOTOR_Pin NEW_LED_Pin */
//  GPIO_InitStruct.Pin = IN1_DCMOTOR_Pin|IN2_DCMOTOR_Pin|NEW_LED_Pin;
//  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
//  GPIO_InitStruct.Pull = GPIO_NOPULL;
//  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
