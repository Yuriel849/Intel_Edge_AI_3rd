...
//	stepmotor_main_test(); // Placed in Task2_func() instead for multithreading

//  dotmatrix_main(); // Placed in Task1_func() instead for multithreading
