...
#include "lwip/udp.h"  // Add TCP
#include "udp_echoserver.h"  // Add TCP
...
extern void get_DHT11(char *tmp);   // ADD_01
...
//------ TCP/IP start -------------
	...
	upcb1 = udp_new();                //Add
	IP4_ADDR(&addr1,10,10,15,99);     //Add My PC IP
...
#if 1
	if (TIM10_10ms_counter >= 150)  //1500ms
	{
		TIM10_10ms_counter=0;
		get_DHT11(temp_str);
