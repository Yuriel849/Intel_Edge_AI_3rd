...
#define PhotoSensorEXTI3_Pin GPIO_PIN_4
#define PhotoSensorEXTI3_GPIO_Port GPIOF
#define MCO_Pin GPIO_PIN_0
#define MCO_GPIO_Port GPIOH
#define PhotoSensorEXTI0_Pin GPIO_PIN_0
#define PhotoSensorEXTI0_GPIO_Port GPIOC
#define PhotoSensorEXTI0_EXTI_IRQn EXTI0_IRQn
#define RMII_MDC_Pin GPIO_PIN_1
#define RMII_MDC_GPIO_Port GPIOC
#define PhotoSensorEXTI1_Pin GPIO_PIN_2
#define PhotoSensorEXTI1_GPIO_Port GPIOC
#define PhotoSensorEXTI1_EXTI_IRQn EXTI2_IRQn
#define PhotoSensorEXTI2_Pin GPIO_PIN_3
#define PhotoSensorEXTI2_GPIO_Port GPIOC
#define PhotoSensorEXTI2_EXTI_IRQn EXTI3_IRQn
...
#define PhotoSensorEXTI5_Pin GPIO_PIN_6
#define PhotoSensorEXTI5_GPIO_Port GPIOB
