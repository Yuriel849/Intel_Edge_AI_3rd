...
void CTimerDlg::OnBnClickedButton1() // Timer 1 Start
{
...
void CTimerDlg::OnBnClickedButton2() // Timer 1 End
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
...
void CTimerDlg::OnBnClickedButton4() // Timer 2 Start
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	m_bTimer1 = 1;
...
void CTimerDlg::OnBnClickedButton3() // Timer 2 End
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
...
void CTimerDlg::OnTimer(UINT_PTR nIDEvent)
{
	...
	if (nIDEvent == 0) AfxMessageBox(_T("Timer_1 3 sec!"));
	if (nIDEvent == 1) AfxMessageBox(_T("Timer_2 5 sec!"));
