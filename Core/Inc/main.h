...
#define SERVOMOTOR_TIM2_CH1_Pin GPIO_PIN_5
#define SERVOMOTOR_TIM2_CH1_GPIO_Port GPIOA
...
#define IN1_MOTOR1_Pin GPIO_PIN_8
#define IN1_MOTOR1_GPIO_Port GPIOE
#define IN2_MOTOR1_Pin GPIO_PIN_9
#define IN2_MOTOR1_GPIO_Port GPIOE
